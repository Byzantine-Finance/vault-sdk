export const DELEGATOR_ABI = [
  {
    ...
    inputs: [
      {
        name: "optInServiceHints",
        type: "address",
        internalType: "address",
      },
      { name: "vaultHints_", type: "address", internalType: "address" },
    ],
  ...
  {
    type: "function",
    name: "FULL_RESTAKE_DELEGATOR_HINTS",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "address" }],
    stateMutability: "view",
  },
  ...
  {
    type: "function",
    name: "NETWORK_RESTAKE_DELEGATOR_HINTS",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "address" }],
    stateMutability: "view",
  },
  ...
  },
  {
    ...
    inputs: [{ name: "subnetwork", type: "bytes32", internalType: "bytes32" }],
  ...
  },
  {
    type: "function",
    name: "setHook",
    inputs: [{ name: "hook_", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  { type: "error", name: "ExternalCall", inputs: [] },
